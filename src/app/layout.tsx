...
export const metadata: Metadata = {
  ...
  applicationName: "Desliza IA",
  appleWebApp: { capable: true, statusBarStyle: "black-translucent", title: "Desliza IA" },
...
export const viewport: Viewport = { themeColor: "#0b0b0f", colorScheme: "dark", width: "device-width", initialScale: 1, viewportFit: "cover" };
